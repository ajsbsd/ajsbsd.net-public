  ...
  return (
    <div>
      ...
      <div className="pt-3 pb-3 pl-3">
        ...
        <br />
        We celebrate the classic sounds of drum & bass and its rich history. Our
        mission is to provide a platform where enthusiasts can explore,
        ...
        articles that pay homage to the pioneers of drum & bass. We take you on
        a journey back to the roots of this electronic music genre, showcasing
        the artists and tracks that continue to inspire generations.
        <br />
        <br />
        We are grateful to <Link href="https://odysee.com">Odysee.com</Link> for
        hosting our content, allowing us to share our passion for older drum &
        bass with a global audience. Join us in celebrating the beats that
        shaped a genre and continue to move dancefloors around the world.
        Experience the rhythm, embrace the nostalgia, and let the music take you
        back to the golden era of drum & bass here.
        <br />
